...
const ChildSubCategory = ({route, navigation}) => {
  ...
  const subcategory_name = route.params.subcategory_name;
  ...
  }, [navigation, subcategory_name]);


  const fetchProductApi = () => {
    var fetchProductAPIURL = API_BASE_URL+`fetchChildCategoryAndProductListBySubCategory.php`;
    var header = {
  ...
  const fetchCategoryBanner = () => {
    ...
    fetch(fetchProductAPIURL, {
      ...
      headers: header,
      body: JSON.stringify({
        category_id: route.params.sub_category_id,
      }),
    })
      .then(response => response.json())
      .then(response => {
                    ...
                    // backgroundColor:'#0984e3',
                     alignSelf: 'center',
                      justifyContent: 'center',
                       ...
                       <Avatar.Image
                    source={{uri: route.params.subcategory_img}}
                    size={100}
                    style={{
                      alignSelf: 'center',
                      elevation: 5,
